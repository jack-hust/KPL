...
void compileBlock(void) {
  ...
  if (lookAhead->tokenType == KW_CONST) {
    ...
    do {
      ...
      // Táº¡o 1 Constant Object cÃ³ tÃªn lÃ  IDENT vá»«a Ä‘á»c Ä‘Æ°á»£c
      ...
      // Add Constant vÃ o báº£ng symtab
...
void compileFuncDecl(void) {
  ...
  eat(KW_FUNCTION);
  eat(TK_IDENT);
  // Táº¡o Function Object cÃ³ name lÃ  IDENT vá»«a Ä‘á»c Ä‘Æ°á»£c
  Object* obj = createFunctionObject(currentToken->string);
  // VÃ o trong scope cá»§a Function Object
  enterBlock(obj->funcAttrs->scope);

  compileParams();
  eat(SB_COLON);
  // Äá»c kiá»ƒu tráº£ vá» cá»§a Function sau dáº¥u ':'
  obj->funcAttrs->returnType = compileBasicType();
  eat(SB_SEMICOLON);

  compileBlock();
  eat(SB_SEMICOLON);
  // Out khá»i scope cá»§a Function Object nÃ y
  exitBlock();
...
void compileProcDecl(void) {
  ...
  eat(KW_PROCEDURE);
  eat(TK_IDENT);
  // Táº¡o Procedure Object cÃ³ name lÃ  IDENT vá»«a Ä‘á»c Ä‘Æ°á»£c
